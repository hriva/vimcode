...
keymap('n', '<C-d>', '<C-d>zz', opts_desc 'page half down centered')
keymap('n', '<C-u>', '<C-u>zz', opts_desc 'page half up centered')
...
keymap('n', '<Leader>rn', '<cmd>lua vim.wo.number = not vim.wo.number<CR>', opts_desc 'toggle display linenumber')
keymap(
    'n',
    '<Leader>tc',
