...
keymap('n', '<Leader>wc', notify 'workbench.action.showCommands', opts) -- find commands
...
keymap('n', '<C-j>', notify 'workbench.action.navigateDown', opts)
keymap('x', '<C-j>', notify 'workbench.action.navigateDown', opts)
keymap('n', '<C-k>', notify 'workbench.action.navigateUp', opts)
...
-- tab related keymaps
keymap('n', '<Leader>bo', [[:Tabonly<cr>]], opts_desc 'tab: delete other tabs')
keymap('n', '<Leader>b', [[:Tabnew<cr>]], opts_desc 'tab: new tab')
keymap('n', '<Leader>x', [[:Tabclose<cr>]], opts_desc 'tab: close this tab')
keymap('n', '<Leader>bf', [[:Tabfirst<cr>]], opts_desc 'tab: first tab')
keymap('n', '<Leader>bl', [[:Tablast<cr>]], opts_desc 'tab: last tab')
-- keymap('n', '<Leader><Tab>[', [[gT]], opts_desc 'tab: previous tab')
-- keymap('n', '<Leader><Tab>]', [[gt]], opts_desc 'tab: next tab')
keymap('n', '<Leader>b1', notify 'workbench.action.openEditorAtIndex1', opts_desc 'tab: 1st tab')
keymap('n', '<Leader>b2', notify 'workbench.action.openEditorAtIndex2', opts_desc 'tab: 2nd tab')
keymap('n', '<Leader>b3', notify 'workbench.action.openEditorAtIndex3', opts_desc 'tab: 3rd tab')
keymap('n', '<Leader>b4', notify 'workbench.action.openEditorAtIndex4', opts_desc 'tab: 4st tab')
keymap('n', '<Leader>b5', notify 'workbench.action.openEditorAtIndex5', opts_desc 'tab: 5st tab')
keymap('n', '<Leader>b6', notify 'workbench.action.openEditorAtIndex6', opts_desc 'tab: 6st tab')
keymap('n', '<Leader>b7', notify 'workbench.action.openEditorAtIndex7', opts_desc 'tab: 7st tab')
