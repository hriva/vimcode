...
-- highlight
local disable_highlight = { 'sql', 'latex', 'markdown_inline', 'regex', 'bash' }
...
-- indent
local disable_indent = { 'python', 'sql', 'latex', 'markdown_inline', 'regex', 'bash' }
...
local disable_textobj = { 'sql', 'latex', 'markdown_inline', 'regex', 'bash', 'vimdoc' }
